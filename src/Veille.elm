...
view model =
    div (styles model)
        ...
        [ h2 (h2Styles model.titre) [text "Mes applications & outils"]
        , span (liendocStyles model.titre) 
        [ a [href "./Youtube.elm"] [ img (List.concat [imgStyles model.titre, [src "./assets/images/yt.jpg"]]) [] ]
        , a [href "./Github.elm"] [ img (List.concat [imgStyles model.titre, [src "./assets/images/github.png"]]) [] ]
        , a [href "./Bot.elm"] [ img (List.concat [imgStyles model.titre, [src "./assets/images/bot.png"]]) [] ]
        ]
        ]
        ]
    ]
