...
view model =
    div (styles model)
        ...
        [ a [href "https://github.com/htr-tech"] [ img (List.concat [imgStyles model.titre, [src "./assets/images/tahmid.png"]]) [] ]
        , a [href "https://github.com/LiliwoL"] [ img (List.concat [imgStyles model.titre, [src "./assets/images/nicola.png"]]) [] ]
        ]
        ]
        ]
    ]
